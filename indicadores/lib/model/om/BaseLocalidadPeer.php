...
abstract class BaseLocalidadPeer {
	...
	const LOCALIDAD = 'localidad.LOCALIDAD';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Localidad', ),
		BasePeer::TYPE_COLNAME => array (LocalidadPeer::ID, LocalidadPeer::LOCALIDAD, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'localidad', ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Localidad' => 1, ),
		BasePeer::TYPE_COLNAME => array (LocalidadPeer::ID => 0, LocalidadPeer::LOCALIDAD => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'localidad' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		include_once 'lib/model/map/LocalidadMapBuilder.php';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocalidadPeer::LOCALIDAD);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LocalidadMapBuilder.php';
