...
class SubactividadProcedimientoPoaEjecucionMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.SubactividadProcedimientoPoaEjecucionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('subactividad_procedimiento_poa_ejecucion');
		$tMap->setPhpName('SubactividadProcedimientoPoaEjecucion');
