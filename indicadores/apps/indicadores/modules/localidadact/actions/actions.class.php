...
/**
 * localidadact actions.
 *
 * @package    indicadores
 * @subpackage localidadact
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 3335 2007-01-23 16:19:56Z fabien $
 */
class localidadactActions extends sfActions
{
  public function executeIndex()
  {
    return $this->forward('localidadact', 'list');
  }
  ...
  public function executeUpdate()
  {
    ...
    return $this->redirect('localidadact/show?id='.$localidad_actividad->getId());
  }
  ...
  public function executeDelete()
  {
    ...
    return $this->redirect('localidadact/list');
  }
}
