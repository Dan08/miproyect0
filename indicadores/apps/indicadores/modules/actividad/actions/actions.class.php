...
class actividadActions extends sfActions
{
  ...
  public function executeUpdate()
  {
    ...
    $actividad->setProyectoInversionId($this->getRequestParameter('proyecto_inversion_id') ? $this->getRequestParameter('proyecto_inversion_id') : null);
    ...
    $actividad->setGiros($this->getRequestParameter('giros'));
    $actividad->setSaldo($this->getRequestParameter('saldo'));
