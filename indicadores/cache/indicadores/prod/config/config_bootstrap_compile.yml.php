...
sfConfig::add(array(
  ...
  'sf_url_format' => 'PATH',
  'sf_orm' => 'propel',
  'sf_ez_lib_dir' => '/var/www/html/indicadores/lib/ezc',
));
...
$log->initialize(array (
  'file' => '/var/www/html/indicadores/log/indicadores_prod.log',
));
...
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "magic_quotes_gpc" key is better set to "false" (current value is "\'\'" - php.ini location: "/etc/php.ini").');
}
if (ini_get('register_globals') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "register_globals" key is better set to "false" (current value is "\'\'" - php.ini location: "/etc/php.ini").');
}
if (ini_get('session.auto_start') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "session.auto_start" key is better set to "false" (current value is "\'0\'" - php.ini location: "/etc/php.ini").');
}
